...
public class FlywheelPollen {
    ...
    public static double kP = FlywheelVars.kP;
    public static double kI = FlywheelVars.kI;
    public static double kD = FlywheelVars.kD;
    public static double kV = FlywheelVars.kV;
    ...
    public FlywheelPollen(HardwareMap hardwareMap, String motorName) {
